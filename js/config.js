...
// NEW: PhotoSwipe Preview Loading Strategy
export const PREVIEW_LOADING_STRATEGY = 'LAZY_LOAD_ON_NAVIGATE'; // Options: 'LOAD_ALL_ON_OPEN', 'LAZY_LOAD_ON_NAVIGATE'
export const PREVIEW_NEAR_END_THRESHOLD = 8; // How many images from end to trigger lazy loading 
